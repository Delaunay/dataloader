...
class PyTorchLoader{
public:
    PyTorchLoader(Dataset const& dataset, const Sampler& sampler, std::size_t batch_size_, std::size_t worker_cout = 6, std::size_t buffering_=1, int seed=0, std::size_t io=0):
